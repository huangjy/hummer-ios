...
@property (nonatomic, strong) NSMutableArray *yogaProperties;
@end
...
HM_YOGA_PROPERTY(flexGrow, flexGrow, HMNumberToCGFloat:);
HM_YOGA_PROPERTY(flexShrink, flexShrink, HMNumberToCGFloat:);
...
//HM_YOGA_PROPERTY(borderLeftWidth, borderLeftWidth, HMNumberToCGFloat:);
//HM_YOGA_PROPERTY(borderTopWidth, borderTopWidth, HMNumberToCGFloat:);
//HM_YOGA_PROPERTY(borderRightWidth, borderRightWidth, HMNumberToCGFloat:);
//HM_YOGA_PROPERTY(borderBottomWidth, borderBottomWidth, HMNumberToCGFloat:);
//HM_YOGA_PROPERTY(borderStartWidth, borderStartWidth, HMNumberToCGFloat:);
//HM_YOGA_PROPERTY(borderEndWidth, borderEndWidth, HMNumberToCGFloat:);
//HM_YOGA_PROPERTY(borderWidth, borderWidth, HMNumberToCGFloat:);
...
- (NSMutableArray *)yogaProperties {
    if(!_yogaProperties){
        _yogaProperties = [NSMutableArray array];
        NSArray *properties = [self.yogaConfig allValues];
        for (HMYogaProperty *prop in properties) {
            [_yogaProperties addObject:prop.yogaProp];
        }
    }
    return _yogaProperties;
}

- (BOOL)isYogaProperty:(NSString *)propName
{
    return [self.yogaProperties containsObject:propName];
}
